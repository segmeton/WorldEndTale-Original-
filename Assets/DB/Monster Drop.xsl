			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 3.957cm"/>
						<col style="WIDTH: 4.359cm"/>
						<col style="WIDTH: 4.359cm"/>
						<col style="WIDTH: 3.259cm"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>Common Drop ID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Uncommon Drop ID</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Rare Drop ID</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="Monster_x0020_Drop">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Enemy_x0020_ID"/>
								</td>
								<td>
									<xsl:value-of select="Common_x0020_Drop_x0020_ID"/>
								</td>
								<td>
									<xsl:value-of select="Uncommon_x0020_Drop_x0020_ID"/>
								</td>
								<td>
									<xsl:value-of select="Rare_x0020_Drop_x0020_ID"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
