		...
		<html>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						<col style="WIDTH: 1.185cm"/>
						<col style="WIDTH: 2.835cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.095cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.052cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.285cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="WIDTH: 6.962cm"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Armor">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Buy_x0020_Price"/>
								</td>
								<td>
									<xsl:value-of select="Sell_x0020_Price"/>
								</td>
								<td>
