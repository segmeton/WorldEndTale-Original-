		...
		<html>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Accessory_x0020_User">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Accesory_x0020_ID"/>
								</td>
								<td>
									<xsl:value-of select="User_x0020_ID"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
